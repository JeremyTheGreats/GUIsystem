...
public class ComputerSets extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        body.add(hover1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 200, 220, 90));

        hovertext1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        hovertext1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        body.add(hovertext1, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 230, 390, 31));

        hovertext2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        hovertext2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        body.add(hovertext2, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 370, 390, 31));
        ...
        body.add(hover2, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 350, 220, 90));
        ...
        hover3.setBackground(new java.awt.Color(202, 240, 248));
        hover3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        hover3.setLayout(null);

        text3.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        text3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        text3.setText("Buy Parts");
        hover3.add(text3);
        text3.setBounds(0, 30, 220, 31);

        body.add(hover3, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 480, 220, 90));
    ...
    private void hover3MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_hover3MouseEntered
        hover3.setBackground(new Color(13,59,102));
    ...
    private void hover3MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_hover3MouseExited
        hover3.setBackground(new Color(202,240,248));
